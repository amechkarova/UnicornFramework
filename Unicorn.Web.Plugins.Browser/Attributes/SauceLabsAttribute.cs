...
namespace Unicorn.Web.Plugins.Browser.Attributes
{
    ...
    {
        public SauceLabsAttribute(Web.Browser browser, string browserVersion, string platform, bool recordVideo,
            bool recordScreenshot, string screenResolution, BrowserBehavior browserBehavior)
